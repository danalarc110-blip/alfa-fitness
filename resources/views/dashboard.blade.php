...
<body class="font-sans antialiased bg-black text-white min-h-screen">
    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="flex items-center justify-between gap-3 px-4 sm:px-6 md:px-10 py-4 sm:py-6 border-b border-white/5 backdrop-blur-sm" data-animate="header">
                <div>
                    <div class="flex items-center gap-2">
                        <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-white">¡Bienvenido, {{ $nombre }}!</h1>
                ...
                <div class="flex items-center gap-3">
                    <button type="button" onclick="alphaToggleTema()" title="Cambiar tema"
                        class="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center text-gray-400 hover:text-yellow-400 transition-all duration-200 active:scale-95 shadow-sm">
            ...
            <div class="flex-1 px-4 sm:px-6 md:px-10 py-6 sm:py-8 space-y-5 sm:space-y-6">
                    ...
                    <div class="alpha-card rounded-2xl p-6 relative overflow-hidden" data-animate="card">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-gray-300 border border-white/10">
                                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1 2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1Z"/></svg>
                            </div>
                        </div>
